...
if (typeof jQuery === 'undefined') {
  throw new Error('Animated-TopNav\'s JavaScript requires jQuery')
}
...
+function ($) {
  ...
  if ((version[0] < 2 && version[1] < 9) || (version[0] == 1 && version[1] == 9 && version[2] < 1) || (version[0] > 3)) {
    throw new Error('Animated-TopNav\'s JavaScript requires jQuery version 1.9.1 or higher, but lower than version 4')
  }
}(jQuery);
...
+function ($) {
  ...
  // ANIMATED-TOPNAV CLASS DEFINITION
  // =========================
